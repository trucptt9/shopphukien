...
public function thanhtoan_vnpay(){
    ...
    //    Session::put('message','Cập nhật thành công');
       return Redirect::to('/account/'.$customer_id)->with('success','Cập nhật thành công');
     }
     //shipping
    ...
    public function update_password_user($customer_id, Request $request){
        ...
        if($result){
            ...
            return Redirect::to('/edit-password/'.$customer_id)>with('error','Cập nhật không thành công');
            }
        }
        else{
