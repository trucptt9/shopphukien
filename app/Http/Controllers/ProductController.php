...
class ProductController extends Controller
{
    ...
    public function tat_ca_sp(Request $request){
        ...
        $category = DB::table('category')->where('category.category_status',1)->orderBy("category_id","desc")->get();
        $brand = DB::table('brand')->where('brand.brand_status',1)->orderBy("brand_id","desc")->get();
